...
- Bounded VNC/WebVNC credential reads to a 30-second SSH operation deadline while preserving connection defaults, caller cancellation, and transport cleanup. Thanks @SebTardif.
